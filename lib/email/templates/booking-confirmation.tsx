	...
	return (
		<BaseEmail previewText={`Booking confirmed at ${hotelName}`}>
			...
			<Text className="mb-6 text-base leading-6 text-gray-700">
				Dear {guestName}, your reservation has been confirmed. We look forward to
				welcoming you!
			</Text>
			...
			<Section className="mb-6 rounded-lg bg-gray-50 p-5">
				<table className="w-full text-sm">
					<tbody>
						...
						<tr>
							<td className="border-t border-gray-200 pt-3 text-gray-600">
								Total Amount:
							</td>
							<td
								className="border-t border-gray-200 pt-3 text-lg font-bold"
								style={{ color: EMAIL_CONFIG.brandColor }}>
			...
			{specialRequests && (
				<Section className="mb-6 rounded-lg bg-blue-50 p-5">
					...
					<Text className="m-0 text-sm text-gray-700">{specialRequests}</Text>
				</Section>
			)}
			...
			<Text className="text-sm text-gray-600">
				If you have any questions or need to make changes to your booking, please don't
