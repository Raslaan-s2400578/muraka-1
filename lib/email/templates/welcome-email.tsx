  ...
  return (
    <BaseEmail previewText={`Welcome to Muraka Hotels, ${name}!`}>
      ...
      <Text className="mb-4 text-base leading-6 text-gray-700">
        Thank you for creating an account with us. We're excited to help you find your perfect stay in the beautiful Maldives.
      </Text>
      ...
      <Text className="text-sm text-gray-600">
        You can now browse our hotels and make bookings at any of our locations across the Maldives.
      </Text>
